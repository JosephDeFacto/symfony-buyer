...
class SaveCommand extends Command
{
    ...
    {
        $this->setName('api:category:save')
            ->setDescription('Save category data to the database')
            ->setHelp('Run this command to populate category database table.');
    }
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $output->writeln('<info>Successfully saved!<error>');
